...
public class Deposit extends JFrame implements ActionListener{
	...
	public Deposit()  {
		...
		l1.setBounds(130, 45, 496, 82);
		getContentPane().add(l1);
		
		l2 = new JLabel("TO DEPOSIT");
		l2.setFont(new Font("Osward", Font.BOLD, 30));
		l2.setBounds(260, 140, 194, 65);
		getContentPane().add(l2);
		
		tf1 = new JTextField(15);
		tf1.setBounds(130, 244, 496, 50);
				...
				try {
					...
					if(Conn.res.next())
					{
						...
						if(p.equals(pin))
						{
							...
							String q2="INSERT INTO BANK VALUES('"+p+"','"+amnt+"','"+0.0+"','"+bal+"')";
							Conn.pstnt=Conn.con.prepareStatement(q2);
							Conn.pstnt.executeUpdate();
							JOptionPane.showMessageDialog(null, "Rs: "+amnt+" Deposited sucessfully");
						}
